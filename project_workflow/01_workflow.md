...
### 1. 現在の状態を確認
**[13_progress.md](./13_progless.md)** を確認し現在作業中なら 「4. 作業管理」を読み続きから作業
...
### 作業中ルール
ファイルを編集し終えた。不具合を解決した。もしくは不具合の修正に５回失敗した場合、ここまでの作業を[13_progless.md](./13_progless.md)に記録します。
完了したら、01_workflow.mdの確認を再度行います。
